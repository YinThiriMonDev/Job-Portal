...
<body>
    ...
    if (isset($_POST['Company_Name'])) {
        ...
        $query = "SELECT * FROM employer WHERE Company_Name LIKE '%$search_name%'";
    } else {
        // Default query to fetch all employers
        $query = "SELECT applying_jobs.*, job_seeker.User_Name, job.Job_Name
          FROM applying_jobs
          INNER JOIN job_seeker ON applying_jobs.User_ID = job_seeker.User_ID
          INNER JOIN job ON applying_jobs.Job_ID = job.Job_ID ";
    ...
    <div class="wrapper">
        ...
        <div id="sidebar">
            ...
            <ul class="list-unstyled component m-0">
                ...
                <li class="dropdown">
                    <a href="change_status.php" data-toggle="collapse" aria-expanded="false">
                        <i class="material-icons">thumbs_up_down</i>Change Status
                    </a>
                </li>
                <li class="dropdown">
                    ...
                    <div class="col-md-12">
                        <div class="table-wrapper">
                                ...
                                <tbody>
                                    <?php while ($row = mysqli_fetch_assoc($result)) : ?>
                                        <tr>
                                            ...
                                            <td>Approve</td>
                                            <td><a href="delete_status.php?did=<?php echo $row['Job_ID'] ?>" class="delete" data-toggle="modal">
                            ...
                            <div name="back_button" class="back_button_div">
                                <a href="employerdashboard.php"> <button class="back_button" style="float:right;"><span>Back </span></button>
                            </div>
