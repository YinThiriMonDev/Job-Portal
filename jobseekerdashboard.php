			...
			<div class="top-navbar">
				<div class="xd-topbar">
							...
							<div class="xp-searchbar">
								<form method="POST" action="">
									<div class="input-group">
										<input type="search" class="form-control" name="job_seeker_name" placeholder="Enter your search term">
					...
					<div class="xp-breadcrumbbar text-center">
						<h4 class="page-title">Job Seeker Information Dashboard</h4>
						<ol class="breadcrumb">
					...
					<div class="col-md-12">
						<div class="table-wrapper">
							...
							<div class="table-title">
								<div class="row">
									...
									<div class="col-sm-6 p-0 flex justify-content-lg-end justify-content-center">
										<a href="job_seeker_registration.php" class="btn btn-success" data-toggle="modal">
											<i class="material-icons">&#xE147;</i>
											<span>Add New Job Seekers</span>
										</a>
								...
								<tbody>
									<?php while ($row = mysqli_fetch_assoc($result)) :
										...
										<tr>
											...
											<td><a href="edit_job_seeker_info.php?eid=<?php echo $row['User_ID'] ?>" class="edit" data-toggle="modal">
													<i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i>
												</a></td>
											<td><a href="delete_job_seeker_info.php?did=<?php echo $row['User_ID'] ?>" class="delete" data-toggle="modal">
							...
							<div name="back_button" class="back_button_div">
								<a href="jobseekerdashboard.php"> <button class="back_button" style="float:right"><span>Back </span></button>
							</div>
