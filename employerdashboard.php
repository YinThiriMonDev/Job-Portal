			...
			<div class="top-navbar">
				<div class="xd-topbar">
					...
					<div class="xp-breadcrumbbar text-center">
						<h4 class="page-title">Employer Information Dashboard</h4>
						<ol class="breadcrumb">
							...
							<div class="table-title">
								<div class="row">
									<div class="col-sm-6 p-0 flex justify-content-lg-start justify-content-center">
										<h2 class="ml-lg-2">Manage Employers</h2>
									</div>
								...
								<tbody>
									...
									?>
										<tr>
											...
											<td><a href="edit_employer_info.php?eid=<?php echo $row['Employer_ID'] ?>" class="edit" data-toggle="modal">
													<i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i>
												</a></td>
											<td><a href="delete_employer_info.php?did=<?php echo $row['Employer_ID'] ?>" class="delete" data-toggle="modal">
