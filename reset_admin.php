...
if (isset($_POST['Submit'])) {
    $name = $_SESSION['name_retrieve'];
    $pass = $_POST['Admin_Password'];
    $cpass = $_POST['Confirm_Password'];

    $check_pass = "SELECT * FROM admin WHERE Admin_Name = '$name'";
    ...
    elseif($result) {
        ...
        $reset_pwd = "UPDATE admin SET Admin_Password = '$pass' WHERE Admin_Name = '$name'";
        ...
        <form method="POST" action="" enctype="multipart/form-data">
            <div class="user-details">
                <div class="input-box">
                    ...
                    <input type="password" id="new-pwd" placeholder="Password must be longer than 6 characters" name="Admin_Password" required>
                </div>
                <div class="input-box">
